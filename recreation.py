...
def run():
    ...
    #Recreation Label
    recreation_label = Label(root, text="Recreation Type: ", fg="white", bg="#262626")
    recreation_label.config(font=("Comic Sans MS", 20))
    recreation_label.place(x=20, y=100)

    #Recreation Dropdown
    recreation_dropdown_menu = OptionMenu(root, variable,'Water Sports', "Hiking",  "Camping", "Rock Climbing", "Cruise", command=cuisine_callbalck)
    recreation_dropdown_menu.config(bg="#262626", fg="white", highlightthickness=0, width=20, height=2)
    recreation_dropdown_menu.place(x=250, y=100)
